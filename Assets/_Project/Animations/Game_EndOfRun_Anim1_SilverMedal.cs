...
public class Game_EndOfRun_Anim1_SilverMedal : MonoBehaviour
{
    ...
    public delegate void PlaySilverMedalAnimCallback(int id);
    public static event PlaySilverMedalAnimCallback OnRequestPlaySilverMedalAnim;
    ...
    private void SetupAnimAndStart(Transform animTarget)
    {
        ...
        // shrink
        float _minScale = 0.21f;
        float _shrinkDuration = 0.10f;
    ...
    {
        OnRequestPlaySilverMedalAnim?.Invoke(id);
    }
