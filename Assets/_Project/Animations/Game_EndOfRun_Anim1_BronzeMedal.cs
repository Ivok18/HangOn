...
public class Game_EndOfRun_Anim1_BronzeMedal : MonoBehaviour
{
    ...
    public delegate void PlayBronzeMedalAnimCallback(int id);
    public static event PlayBronzeMedalAnimCallback OnRequestPlayBronzeMedalAnim;
    ...
    {
        OnRequestPlayBronzeMedalAnim?.Invoke(id);
    }
